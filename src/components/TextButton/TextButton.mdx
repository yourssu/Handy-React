...
필수 프로퍼티인 `variant`를 사용하여 TextButton의 외형을 설정해주세요.<br />
...
```tsx
<TextButton size="medium" variant="primary" disabled={true}>
...
```tsx
<TextButton size="medium" variant="primary" width="500px">
