...
- Scrollable Tab: `scrollable = true` 입니다. `Tabs.Tab`이 4개 이상일 경우 사용합니다.<br /><br />
...
List와 Panel을 감싸는 루트 컴포넌트입니다. `defaultTab`, `scrollable`을 프로퍼티로 넘길 수 있습니다.

### Tabs.List

1개 이상의 Tab을 감싸는 컴포넌트입니다. (단독 사용시 에러가 발생합니다)
